...
- [x] タイポグラフィのプリセットを定義（DESIGN.md §3 の表に対応：サマリー大数字 26/500、画面タイトル 17/500、本文 14/400 など）。ウェイトは 400 / 500 のみ
- [x] 共通部品を作成
...
- [x] カテゴリ・タイミング・服用パターンの定数と日本語ラベルを定義
